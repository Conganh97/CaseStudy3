            ...
            <table class="table table-dark table-striped">
                ...
                <c:forEach var="hd" items="${list}">
                    <tr>
                        ...
                        <td>
                            ...
                            <a style="color: white" href="/giohang?order=chitiet&idhdct=${hd.idhd}">Chi tiet</a>
                            </button>
                        </td>
                    </tr>
                </c:forEach>
                <tr>
                    <td colspan="5" align="center">
                        ...
                        <button type="submit" class="btn btn-dark"><a style="color: white" href="/menu.jsp">Back</a></button>
                    </td>
                </tr>
            </table>
        </form>

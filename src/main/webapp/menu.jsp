          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="user_option">
              ...
              <form class="form-inline">
                ...
                <button style="width: 100px ; height: 40px; font-size: 15px" type="button" class="btn btn-secondary"><a style="background: none ; color: white" href="/index?action=logout">Log out</a></button>
              </form>
            </div>
          </div>
        </nav>
                ...
                <div>
                  ...
                  <div class="detail-box">
                    ...
                    <div class="options">
                      ...
                      <a href="/giohang?order=create&id=${list.idsp}">

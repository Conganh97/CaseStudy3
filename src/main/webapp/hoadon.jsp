...
<section class="food_section layout_padding">
    ...
    <div align="center">
        ...
        <table class="table table-dark table-striped">
            ...
            <tr>
                    <td><input type="text" name="tensp" value="${list.getTensp()}" disabled><br/></td>
                    <td><input type="text" name="gia" value="${list.getGia()}" disabled><br/></td>
                    <td><input type="text" name="sl" value="${list.getSl()}" disabled><br/></td>
            </tr>
                </c:forEach>
            <tr>
                <td colspan="2" align="center">Total Bill <input type="text" name="trigia" id="trigia" value="${hoadon.trigia}" disabled></td>
                <td><button class="btn btn-secondary" type="button">
                    <a style="color: white" href="/index?action=logout"> Back to home </a>
                </button></td>
            </tr>
        </table>
<h1> </h1>
        <h1 align="center">Thank you for ordered</h1>
        <h1> </h1>
